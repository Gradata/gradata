...
class TestArchitectureLayers:
    ...
    @pytest.mark.parametrize("module", [
        "orchestrator", "pipeline", "parallel", "human_loop",
    ...
    @pytest.mark.parametrize("module", [
        "scope", "rule_engine", "rule_tracker",
    ])
    ...
    @pytest.mark.parametrize("module", [
        ...
        "metrics", "quality_monitoring", "reporting", "carl",
        "learning_pipeline",
    ])
...
class TestResearchBackedConstants:
    ...
    def test_min_applications_few_shot(self):
        ...
        from gradata.enhancements.self_improvement import MIN_APPLICATIONS_FOR_PATTERN, MIN_APPLICATIONS_FOR_RULE
