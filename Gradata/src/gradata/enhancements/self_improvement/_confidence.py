"""
Confidence math submodule for the self_improvement package.

Contains: constants, FSRS functions, Bayesian blending,
parse_lessons, format_lessons, update_confidence, and helpers.

All graduation constants (PATTERN_THRESHOLD, RULE_THRESHOLD, etc.)
also live here and are imported by _graduation.py.
"""
...
# ---------------------------------------------------------------------------
# Propagation / Velocity / Maturity / Formatting
# ---------------------------------------------------------------------------
...
# Backward-compat re-exports live in the package __init__.py only.
