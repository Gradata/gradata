"""Execute-then-verify loop with root-cause retry routing: execute→qualify (fresh files vs spec)
→score PASS/GAP/DRIFT→classify (intent/spec/code)→retry up to max_attempts."""
