"""Layer 0: base agentic patterns. Pure logic, no external deps; never imports enhancements/.
Lazy-loads submodules (Pipeline/Stage, SmartRAG/NaiveRAG, InputGuard/OutputGuard) on first use."""
