"""Two-phase guardrails — input pre-exec, output post-exec. Composable via Guard/InputGuard/
OutputGuard; ``guarded()`` wires them. Built-ins: pii, injection, scope, banned, destructive."""
