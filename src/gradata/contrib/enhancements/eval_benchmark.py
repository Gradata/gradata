"""Procedural-memory eval benchmark (LoCoMo-comparable). Dimensions:
(1) correction recall; (2) rule precision (do rules prevent re-occurrence);
(3) graduation accuracy (INSTINCT→PATTERN→RULE correctness).
"""
