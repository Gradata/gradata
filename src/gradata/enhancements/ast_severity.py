"""AST-aware severity: scores structural deltas via ``ast.dump()`` diff.
Reformats→"as-is"; up-weights signature/control-flow edits. Gated by
ast_severity_enabled + language. Labels mirror diff_engine thresholds.
"""
