"""Self-healing: on RULE (conf≥0.80) failing to block a covered correction, ``detect_rule_failure``
→ ``generate_patch_candidate`` → ``retroactive_test``; passing candidates re-enter at INSTINCT."""
