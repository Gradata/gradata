"""Confidence decay for unused lessons (pure, no I/O). Ebbinghaus-style: RULE immune, -0.02/idle
(floor 0.10), +0.05/apply; 20+ idle → UNTESTABLE archive. Brain wiring lives in scripts/."""
