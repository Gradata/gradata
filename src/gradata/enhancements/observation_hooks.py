"""Deterministic 100%-capture tool-use hooks for the learning pipeline. Project-scoped via
git-remote hash; fires on every tool call (no sampling) to feed graduation."""
