"""Reporting — brain briefing + health reports as agent-agnostic markdown. ``generate_briefing``
returns ``BrainBriefing``; ``export_briefing`` fans out to CLAUDE.md/.cursorrules/copilot."""
