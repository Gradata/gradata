"""Correction content-provenance hashing + source-context classification. SHA-256 canonical
``(before, after, source_context)``; untrusted→``requires_review`` blocks graduation."""
