"""Adversarial-phrase blocklist for correction ingest — flags prompt-injection triggers via
substring match so approval_required intercepts graduation. Recall-optimised, not GCG suffixes."""
