"""Per-brain 32-byte salt in `.brain_salt` jitters PATTERN/RULE thresholds
by ±5%, so an attacker knowing the algorithm can't predict exact confidence
boundaries for a specific brain.
"""
