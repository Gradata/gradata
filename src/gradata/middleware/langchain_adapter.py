"""LangChain BaseCallbackHandler: injects <brain-rules> on prompt start and validates output
against RULE regexes on llm_end. For stricter control prefer ``OpenAIMiddleware`` around clients."""
