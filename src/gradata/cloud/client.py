"""CloudClient — API client for Gradata Cloud. Auth, brain sync, graduation routing; drop-in
for ``Brain.correct``/``apply_brain_rules``. Synchronous urllib only — zero-dependency."""
