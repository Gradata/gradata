"""Opt-in anonymous SDK telemetry — ``{event, sha256(machine_id), ISO-ts, sdk_version}`` only, never
content. Default OFF; ``GRADATA_TELEMETRY=0`` kill-switch. At most once per machine per install."""
