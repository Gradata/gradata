"""Opt-in Mem0 adapter (``MemoryAdapter`` protocol). Mirrors corrections to
a Mem0 workspace. Install: ``pip install "gradata[adapters-mem0]"``.
Never raises on backend failure — host brain stays up if Mem0 is down.
"""
