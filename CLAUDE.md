...
* **QUALITY BAR** — All outputs (code, docs, architecture, SDK) must meet enterprise-grade professional standards. Anthropic-level polish. No rough drafts, no "good enough," no prototype-quality shipped as final.
...
Current phase: **INFANT (Session 40/50).** Transition at session 50.
