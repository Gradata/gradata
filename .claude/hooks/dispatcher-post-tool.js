 ...
 *   14. auto_correct.py        (Edit) — auto-detect corrections from edits
 */
...
const hooks = [
  ...
  { matcher: 'Edit', type: 'python', script: path.join(cfg.WORKING_DIR, 'sdk', 'src', 'gradata', 'hooks', 'auto_correct.py'), timeout: 5000 },
];
