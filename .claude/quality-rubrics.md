...
# Output Quality Guidance & Floor
# Self-score every output before presenting to Oliver. If below 7, revise before showing.
# These rubrics guide per-output quality. The 7+ floor is enforced.
# Session-level scoring is handled by the binary checklist gate in auditor-system.md.
