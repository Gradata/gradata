...
**Load:** skills/tools/prompt-master/SKILL.md
...
**Load:** skills/dev/fitfo/SKILL.md
...
**Load:** skills/dev/focused-fix/SKILL.md
...
**Load:** skills/dev/agent-workflow-designer/SKILL.md
...
**Load:** skills/dev/spec-driven-workflow/SKILL.md
...
**Load:** skills/dev/pr-review-expert/SKILL.md
...
**Load:** skills/dev/code-reviewer-team/SKILL.md
...
**Load:** skills/core/self-improving-agent/SKILL.md
...
**Load:** skills/dev/mcp-server-builder/SKILL.md
...
**Load:** skills/dev/dependency-auditor/SKILL.md
...
**Load:** skills/sales/competitive-teardown/SKILL.md
...
**Load:** skills/dev/experiment-designer/SKILL.md
...
**Load:** skills/sales/product-discovery/SKILL.md
...
Salesably skills (skills/sales/sales-skills/skills/) — load only the specific one relevant to the task, never all 9.
...
3 lines max. Only surface what's time-sensitive:
```
[check] Context loaded | [calendar] [Today's demos/meetings, or "clear"]
[tasks] [Top 2-3 from loop-state.md "Next Session Tasks" — one line]
[alert] [ONLY if something is broken or overdue — otherwise omit entirely]
```

Do not dump a wall of text. Confirm loaded, respond to Oliver's request.
