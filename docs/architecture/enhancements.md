...
Computes edit distance between draft and final versions. Classifies severity on a 5-level scale: as-is, minor, moderate, major, and discarded. Severity weights influence how strongly a correction affects lesson confidence.
...
1. Score the output against quality rubric
2. If below threshold, identify gaps and fix
3. Re-score
4. Repeat until passing or escalate after retry limit
