...
3. **Open source core, cloud intelligence.**
   The local SDK is AGPL and always will be. What happens on gradata.ai is where the brain compounds: cross-session scoring, graduation optimization, severity trend analysis. Install locally. See the growth in the cloud.
...
Direct answer:
> AGPL means: if you run Gradata in a product you distribute (SaaS, API), you share your modifications. It does not affect internal use. It does not affect using Gradata to train your own brains. It does not affect running Gradata in your own tooling.
>
> The practical effect for 95% of developers: none. The practical effect for companies that want to fork Gradata and sell it without contributing back: they can't. That's intentional. It keeps the community improvements in the commons. If AGPL is a dealbreaker for your use case, enterprise licensing is available.
...
>
> After 73 sessions: 142 rules at 0.90+ confidence, correction rate declining, six categories where errors have been fully eliminated. The code is AGPL, the SDK is pip-installable, and the cloud dashboard (gradata.ai) is in development.
>
...
| **Open source** | Yes (AGPL-3.0) | Yes (Apache 2.0) | Yes (Apache 2.0) | Partial | Yes (MIT) |
...
>
> AGPL vs Apache: For internal use, these are identical in practice. AGPL affects redistribution as SaaS. See the FAQ.
...
- Compound quality score (visible number, not just terminal output)
- Graduation optimization (cloud runs better graduation engine)
- Manifest export to PDF / shareable link
- Ablation testing UI
- sqlite-vec semantic search (free to run locally, cloud-enhanced version is Pro)

Philosophy: free should be genuinely useful. A developer running Gradata locally without a dashboard account should feel like they have a real tool, not a crippled demo. The upsell is visibility and intelligence, not basic function.
...
- Legal: commercial license for teams that AGPL is a concern for
...
### "Why AGPL Is Actually Good for You" Messaging

Put this in the FAQ on gradata.ai. Do not bury it.

**Headline:** AGPL explained in plain language

**Body:**

> AGPL-3.0 means: if you modify Gradata and run it as a service (SaaS, hosted API), you must release your modifications under the same license.
>
> It does not mean:
> - You can't use Gradata in your own product
> - You can't use Gradata internally
> - You can't build a business on top of Gradata
> - You can't keep your brains private
>
> The rule is simple: use it freely, improve it privately, keep the improvements private for internal use. Share modifications if you ship them to others.
>
> Why AGPL instead of MIT? Because MIT would allow well-funded companies to fork Gradata, improve it, and never give anything back. AGPL keeps community improvements in the commons. The companies who care about this are the ones building derivative products to sell — not the ones using Gradata as a tool.
>
> If AGPL is genuinely a problem for your use case, enterprise licensing is available. Contact us.
