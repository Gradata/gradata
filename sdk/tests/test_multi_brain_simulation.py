...
def _make_lesson(
    ...
    _PHRASES: dict[str, list[str]] = {
        ...
        "VERIFICATION": [
            ...
            "validate email with ZeroBounce before upload",
        ...
        "CONSTRAINT": [
            ...
            "Calendly link is mandatory CTA, not website",
        ...
        "DEMO_PREP": [
            ...
            "use NotebookLM for deep research before calls",
        ],
    }
...
def test_compound_score_across_personas(all_brains: list[BrainState]) -> None:
    ...
    for brain in all_brains:
        ...
        score = _compound_score(
            ...
            fda=None,  # no FDA data in simulation
    ...
    def _score_brain(b: BrainState) -> float:
        ...
        return _compound_score(0.02, None, len(grad), len(act), b.session_count, b.session_count * 2)
