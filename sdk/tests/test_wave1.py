...
class TestDiffEngine:
    def test_identical_texts(self):
        from aios_brain._diff_engine import compute_diff
...
class TestEditClassifier:
    def test_classify_returns_list(self):
        from aios_brain._diff_engine import compute_diff
        from aios_brain._edit_classifier import classify_edits
    ...
    def test_summarize_edits(self):
        from aios_brain._diff_engine import compute_diff
        from aios_brain._edit_classifier import classify_edits, summarize_edits
...
class TestScopeBuilder:
    def test_build_scope_sales_email(self):
        from aios_brain._scope import build_scope, RuleScope
    ...
    def test_scope_matches_wildcard(self):
        from aios_brain._scope import scope_matches, RuleScope
    ...
    def test_scope_roundtrip(self):
        from aios_brain._scope import RuleScope, scope_to_dict, scope_from_dict
...
class TestMetrics:
    def test_compute_blandness_empty(self):
        from aios_brain._metrics import compute_blandness
    ...
    def test_metrics_window_defaults(self):
        from aios_brain._metrics import MetricsWindow
        m = MetricsWindow()
...
class TestFailureDetectors:
    def test_no_alerts_without_baseline(self):
        from aios_brain._metrics import MetricsWindow
        from aios_brain._failure_detectors import detect_failures
    ...
    def test_format_alerts(self):
        from aios_brain._failure_detectors import Alert, format_alerts
