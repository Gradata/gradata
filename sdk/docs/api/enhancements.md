...
Layer 1 enhancements build on Layer 0 patterns. Import from `gradata.enhancements`.

## Self-Improvement

```python
from gradata.enhancements.self_improvement import parse_lessons, Lesson
...
```python
from gradata.enhancements.failure_detectors import detect_failures
from gradata.enhancements.metrics import compute_metrics
...
```python
from gradata.enhancements.correction_tracking import compute_correction_profile
...
```python
from gradata.enhancements.brain_scores import compute_brain_scores
...
```python
from gradata.enhancements.judgment_decay import compute_decay, compute_batch_decay
...
```python
from gradata.enhancements.truth_protocol import verify_claims, verify_citations, verify_mutations
