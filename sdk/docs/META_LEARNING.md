...
```
External signal (Gmail reply, Pipedrive deal update, Calendar booking)
...
2. **Can't be gamed:** Edit distance is computed from real diffs. External signals come from 3rd party APIs (Gmail, Pipedrive, Calendar). The brain can't declare its own success.
