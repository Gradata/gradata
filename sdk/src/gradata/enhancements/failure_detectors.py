...
def detect_being_ignored(
    ...
    avg_edit_distance does *not* decrease at the same pace.  This means
    ...
    Thresholds (warning):
        ...
        AND avg_edit_distance decreased by < 5% relative to previous.
    """
    ...
    if previous.avg_edit_distance == 0:
        return []

    ed_pct_change = (
        current.avg_edit_distance - previous.avg_edit_distance
    ) / previous.avg_edit_distance  # negative = lower edit distance
        ...
        return [
            Alert(
                ...
                evidence={
                    ...
                    "prev_avg_edit_distance": previous.avg_edit_distance,
                    "curr_avg_edit_distance": current.avg_edit_distance,
