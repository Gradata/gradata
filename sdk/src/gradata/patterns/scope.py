...
DEFAULT_TASK_TYPES: list[TaskType] = [
    ...
    TaskType(
        name="prospecting",
        keywords=[
            "find leads", "find prospects", "prospect list",
            "build a list", "identify leads",
        ],
        domain_hint="sales",
    ),
    TaskType(
    ...
    TaskType(
        name="crm_update",
        keywords=[
            "update crm", "log a note", "crm note", "update pipedrive",
...
def register_task_type(
    ...
    *,
    ...
    Example::
        ...
        from gradata.patterns.scope import register_task_type
