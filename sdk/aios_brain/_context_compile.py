...
TASK_KEYWORDS = {
    "drafting": ["draft", "email", "write", "follow-up", "follow up", "reply", "send", "outreach"],
    "meeting_prep": ["demo", "call", "meeting", "prep", "present", "onboard"],
    "prospecting": ["research", "qualify", "enrich", "find", "prospect", "list", "leads"],
...
def compile_context(message: str, prospect: str = None, task: str = None) -> str:
    ...
    try:
        from aios_brain._context_packet import build_packet
        packet = build_packet(
